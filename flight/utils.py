...
def addDomesticFlights():
    ...
    for i, line in tqdm(enumerate(file), total=total):
        ...
        economy_fare = float(data[11].strip())*0.012 if data[11].strip() else 0.0
        business_fare = float(data[12].strip())*0.012 if data[12].strip() else 0.0
        first_fare = float(data[13].strip())*0.012 if data[13].strip() else 0.0
